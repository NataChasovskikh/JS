...
const galleryItems = [
 ...
 function addImg() {
  ...
  function changeView(event) {
    ...
    general(target);
    opacityPreview(target);
  }  
  
  function general(elem) {
    fullviewImg.src = elem.dataset.fullview;
  }
  
  function opacityPreview(elem) {
    const currentElem = document.querySelector(".previewClass");
    if (currentElem) {
      currentElem.classList.remove("previewClass");
    }
    elem.classList.add("previewClass");
  }

previewGallery.addEventListener("click", changeView);
